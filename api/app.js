...
const registrantRouter = require('./routes/registrantRouter');
...
app.use('/api/v1.0.0/registrants', registrantRouter);
app.use('/api/v1.0.0/tours', tourRoutes);
app.use('/api/v1.0.0/facilities', facilityRouter);
app.use('/api/v1.0.0/opinions', opinionRouter);
